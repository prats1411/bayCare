                ...
                <div class="col-lg-12">
                    <div style="margin-bottom: 0;" class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="danger">
                                <h3> 会社の削除 </h3>
                                <p>一度削除されてしまいますと復元はできかねておりますのでお気をつけください。</p>
                                <div align="center">
                                    <span type="button" id="delete-button"><i class="btn btn-primary">削除</i></span>
                                </div>
                                <div id="confirm" class="modal animate fade-in-right">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <h3>本当にこちらの会社を削除してもよろしいでしょうか。</h3>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" data-dismiss="modal" class="btn">削除</button>
                                            <a href="companyDelete.php?id=<?php echo $company['id']; ?>" class="btn btn-danger">取消</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="form" class="form-horizontal">
                                ...
                                <div id="div-info" class="form-group">
                                    ...
                                    <div class="container1 col-sm-10">
                                        <textarea name="additional_text" style="margin-bottom: 20px;" class="form-control" id="infoadd" rows="4" aria-required="true"><?php echo $company['additional_text'] ?></textarea>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-2 control-label">回数</label>
                                    <div class="col-sm-10">
